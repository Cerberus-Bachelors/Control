...
CallbackReturn ODriveHardwareInterface::on_init(const hardware_interface::HardwareInfo & info)
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("ODrive"), "Init...");
  ...
  RCLCPP_INFO(rclcpp::get_logger("ODrive"), "Init2...");
  ...
  RCLCPP_INFO(rclcpp::get_logger("ODrive"), "Init3...");
  ...
  RCLCPP_INFO(rclcpp::get_logger("ODrive"), "Init4...");
